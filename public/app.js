...
const locationTemplates = {
    ...
    '오르비스 파티 퀘스트(올비경파)': ['좌1', '좌2', '좌3', '우1', '우2', '우3'],
    '오르비스 파티 퀘스트(올비완파)': ['좌1', '좌2', '좌3', '우1', '우2', '우3'],
    '차디찬벌판': ['좌1', '좌2', '좌3', '우1', '우2', '우3'],
    '죽은나무의숲2': ['좌1', '좌2', '우1', '우2'],
    '죽은나무의숲3': ['좌1', '우1', '우2'],
    '죽은나무의숲4': ['1층', '2층'],

    '루디브리엄 파티 퀘스트': ['1', '2', '3', '4', '5', '6'],
    '몬스터 카니발(3,4필드)': ['승', '승', '패', '패'],
    '몬스터 카니발(5,6필드)': ['승', '승', '승', '패', '패', '패'],
    '시간의길1': ['5층', '4층', '3층', '2층', '1층'],
    '시간의길4': ['4,5층', '3층', '2층', '1층'],
    '삐뚤어진 시간(듀파/듀미굴)': ['5층', '4층', '3층', '2층', '1층', '경심'],
    '사라진 시간(마데테)': ['5,6층', '4층', '3층', '2층', '1층'],

    '위험한 바다 협곡2(오징어/원양어선)': ['5층', '4층', '3층', '2층', '1층', '경심'],
    '깊은 바다 협곡2(망둥)': ['집뿌기사', '고깐', '중깐', '저깐', '프리'],

    '하늘 둥지 입구': ['나무꾼', '로어1', '로어2', '로어3', '경심'],
    '하늘 둥지2': ['기사', '손님'],
    '붉은 켄타우로스의 영역(4인)': ['좌2', '우2', '경심', '1층'],
    '붉은 켄타우로스의 영역(5인)': ['좌2', '우2', '경심', '좌1', '우1'],
    '불과 어둠의 전장(4인)': ['좌1,2', '좌3', '우1,2', '우3'],
    '불과 어둠의 전장(5인)': ['좌1', '좌2', '좌3', '우1,2', '우3'],
    '불과 어둠의 전장(6인)': ['좌1,2', '좌3', '좌3', '우1,2', '우3', '우3'],
    '산양의 골짜기1': ['심매미', '3,4층', '1,2층'],
    '숲의 갈림길': ['경심', '3층(좌)', '3층(우)', '2층(좌)', '2층(우)', '1층'],
    '용의 숲 입구': ['좌3', '좌2', '우2', '1층', '경심'],
    '불타는 숲(3인)': ['2,3,4층', '좌1(다크)', '우1(그린)'],
    '불타는 숲(4인)': ['2,3,4층', '좌1(다크)', '우1(그린)', '경심'],
    '협곡의 동쪽길(3인)': ['3,4층', '1,2층', '경심'],
    '협곡의 동쪽길(4인)': ['옥상', '3층', '1,2층', '경심'],
    '협곡의 동쪽길(5인)': ['옥상', '3층', '고깐', '저깐', '경심'],
    '블루 와이번의 둥지(3인)': ['중옥', '바닥', '경심'],
    '블루 와이번의 둥지(4인)': ['옥상', '중앙', '바닥', '경심'],
    '블루 와이번의 둥지(5인)': ['옥상', '좌2', '우2', '바닥', '경심'],
    '레드 와이번의 둥지': ['옥상', '2,3층', '1층', '경심'],
    '망가진 용의 둥지(4인)': ['옥상', '2층', '1층', '경심'],
    '망가진 용의 둥지(5인)': ['옥상', '2층', '좌1', '우1', '경심'],
    '망가진 용의 둥지(6인)': ['옥상', '좌2', '우2', '좌1', '우1', '경심'],
    '위험한 용의 둥지(4인)': ['옥상', '2층', '1층', '경심'],
    '위험한 용의 둥지(5인)': ['옥상', '좌2', '우2', '바닥', '경심'],
    '위험한 용의 둥지(6인)': ['옥상', '좌2', '우2', '좌1', '우1', '경심'],
    '남겨진 용의 둥지1(2인)': ['3,4층', '1,2층'],
    '남겨진 용의 둥지1(3인)': ['3,4층', '2층', '1층'],
    '남겨진 용의 둥지1(4인)': ['4층', '3층', '2층', '1층'],
    '큰 둥지 봉우리': ['2층', '좌1', '중앙', '우1']
};
...
const partyDescriptionInput = document.getElementById('partyDescriptionInput'); // 파티 설명
const partyDescriptionContainer = document.getElementById('partyDescriptionContainer'); // 파티 설명, 수정 버튼
const partyDescriptionEdit = document.getElementById('partyDescriptionEdit');
const editDescriptionBtn = document.getElementById('editDescriptionBtn');
const partyDescriptionView = document.getElementById('partyDescriptionView'); // 파티원 파티 설명
